<x-frontend-layout>
    <section class="relative">
        ...
        <img class=" w-full h-[60vh] md:h-[85vh] object-cover" src="{{ asset(Storage::url($vendor->shop->logo)) }}" alt="{{ $vendor->shop->name }}">
        <div class="grid grid-cols-12 items-center absolute bottom-0 left-5 md:left-10 lg:left-20 right-5 md:right-10 lg:right-20 h-auto md:h-[10vh] py-4 md:py-0">
            <img class="" src="{{ asset(Storage::url($vendor->shop->logo)) }}" alt="{{ $vendor->shop->name }}">
            <div class="col-span-11 px-5 bg-black opacity-60 text-white h-full flex items-center justify-between">
                <div>
